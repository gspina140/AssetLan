...
{\inferrule*[right=(Fun)]
{\cdots}
{Id(D)[Y_1,\cdots,Y_m]\{D_1 S\}: \Sigma''} \\ \Sigma' =\Sigma \triangleright [Y_1 \rightarrow \bot, \cdots, Y_m \rightarrow \bot]}
...
{\inferrule*[right=(Fun)]
{\cdots}
{Id(D)[Ae_1,\cdots,Ae_n]\{D_1 S\}: \Sigma''}
}
{\Sigma \models Id(E_1,\cdots,E_n)[Ae_1,\cdots,Ae_m]}
\]
\captionof*{figure}{Initialization Call rule (All the asset expression ($Ae_i$) are integers according to the other rules)}
...
\lstinputlisting{program1.al}
\lstinputlisting{program2.al}
\lstinputlisting{program3.al}
\lstinputlisting{program4.al}
