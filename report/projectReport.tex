...
\Gamma, n :
	...
	\end{cases}
\end{equation}
\captionof*{figure}{Where $T=\{int, bool\}$, $A=\{true, false\}$, and $n, n'$ represents the offsets.}
...
\begin{mathpar}
\inferrule{ $[],0 \models F : \Gamma, n$ \\ $\Gamma,n \models Ad : \Gamma_1,n_1$ \\ $\Gamma_1, n_1 \models Fn : \Gamma_2, n_2$ \\ $\Gamma_2, n_2 \models InitC : T$ }
{a}
\end{mathpar}
