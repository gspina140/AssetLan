...
\Gamma, n :
	...
	\end{cases}
\end{equation}
\captionof*{figure}{Where $T=\{int, bool\}$, $A=\{true, false, \top \}$, and $n, n'$ represents the offsets.}
...
\]
\captionof*{figure}{Move operation rule ($\odot$ is the abstract move operation defined in ...)}
...
\[
\inferrule*[right=(Ite)]
{\Gamma \models E : \: bool \\ \Gamma \models S : \: \Gamma', T \\ \Gamma \models S' : \: \Gamma'', T1 \\ T=T1}
{\Gamma \models if(E)\{S\} \: else\{S'\}: \: max(\Gamma',\Gamma''),  T }
\]
